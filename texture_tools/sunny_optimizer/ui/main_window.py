...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        previews_layout = QtWidgets.QVBoxLayout(previews_widget)
        previews_layout.setContentsMargins(0, 0, 0, 0)
        previews_layout.setSpacing(10)
        previews_layout.addLayout(previews, 1)
        previews_layout.addLayout(preview_controls)
        ...
        self.preview_palette_splitter = QtWidgets.QSplitter(QtCore.Qt.Vertical)
        self.preview_palette_splitter.setObjectName("previewPaletteSplitter")
        self.preview_palette_splitter.setChildrenCollapsible(False)
        self.preview_palette_splitter.addWidget(previews_widget)
        self.preview_palette_splitter.addWidget(palette_preview_card)
        self.preview_palette_splitter.setStretchFactor(0, 3)
        self.preview_palette_splitter.setStretchFactor(1, 1)
        center_panel.addWidget(self.preview_palette_splitter)
