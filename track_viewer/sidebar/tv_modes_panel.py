...
class TvModesPanel(QtWidgets.QWidget):
    ...
    def __init__(self, parent: Optional[QtWidgets.QWidget] = None) -> None:
        ...
        camera_action_layout = QtWidgets.QHBoxLayout()
        camera_action_layout.addWidget(self._delete_button)
        camera_action_layout.addWidget(self._add_type6_button)
        camera_action_layout.addWidget(self._add_type2_button)
        camera_action_layout.addWidget(self._add_type7_button)
        camera_action_layout.addStretch(1)
