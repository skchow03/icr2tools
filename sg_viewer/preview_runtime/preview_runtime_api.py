...
class ViewerRuntimeApi:
    ...
    def __init__(
        ...
        *,
        ...
        geometry_service: PreviewGeometryDomainService | None = None,
        edit_manager: EditManager | None = None,
    ) -> None:
        self._preview_context = preview_context
        self._geometry_service = geometry_service or PreviewGeometryDomainService()
    ...
    def find_connection_target_intent(
        self,
        *,
        dragged_key: tuple[int, str],
        dragged_pos: tuple[float, float],
        sections: list[SectionPreview],
        snap_radius: float,
    ) -> tuple[int, str] | None:
        return self._geometry_service.find_connection_target(
