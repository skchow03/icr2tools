...
class BackgroundImageDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self._scale_field.setRange(0.01, 1_000_000_000.0)
...
#        self._scale_field.setSuffix(" 500ths/px")
        ...
        form.addRow("X at upper left of image:", self._origin_u_field)
        form.addRow("Y at upper left of image:", self._origin_v_field)
