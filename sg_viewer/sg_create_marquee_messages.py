...
EXTRA_CREW_MESSAGES: list[str] = [
    ...
    "The wall crew has installed confidence at key impact points.",
    ...
    "The pit wall has requested a union representative.",
    ...
    "The trackside scenery has passed its background check.",
