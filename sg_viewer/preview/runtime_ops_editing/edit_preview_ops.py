    ...
    def set_sections(
        ...
        *,
        ...
        edit_context = capture_edit_context(
            ...
            centerline_index=self._section_manager.centerline_index,
            sampled_dlongs=self._section_manager.sampled_dlongs,
        ...
        if preserved_start_finish_dlong is None:
            preserved_start_finish_dlong = edit_context.start_finish_dlong
        if preserved_start_finish_dlong is None:
