...
class SGViewerWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *, wire_features: bool = True) -> None:
        ...
        self._tso_select_filename_regex_button = QtWidgets.QPushButton(
            "Select by Filename Regex..."
        )
        ...
        self._tsd_sort_objects_by_dlong_button.setToolTip(
        ...
        tso_advanced_layout.addWidget(self._tso_select_filename_regex_button)
        ...
        self._tso_select_filename_regex_button.setToolTip(
    ...
    @property
    def tsd_sort_objects_by_dlong_button(self) -> QtWidgets.QPushButton:
        return self._tsd_sort_objects_by_dlong_button
    ...
    @property
    def tso_select_filename_regex_button(self) -> QtWidgets.QPushButton:
        return self._tso_select_filename_regex_button
