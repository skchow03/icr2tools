...
class SGViewerWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *, wire_features: bool = True) -> None:
        ...
        self._three_d_file_section_pointers_button = QtWidgets.QPushButton("Show section pointers")
        ...
        track_group_layout.addWidget(self._three_d_file_section_pointers_button)
    ...
    @property
    def three_d_file_section_pointers_button(self) -> QtWidgets.QPushButton:
        return self._three_d_file_section_pointers_button
