...
class SectionsController:
    ...
    def on_sections_changed(self) -> None:
        ...
        self._host._window.raise_lower_elevations_button.setEnabled(has_sections)
        self._host._window.flatten_elevations_button.setEnabled(has_sections)
    ...
    def add_fsect_below_selected(self) -> None:
        ...
        if not fsects:
            ...
            row_index = self._host._window.selected_fsect_index()
        ...
        self._host._window.select_fsect_index(insert_index)
    ...
    def delete_selected_fsect(self) -> None:
        ...
        if remaining:
            self._host._window.select_fsect_index(min(row_index, remaining - 1))
        self._host._update_fsect_edit_buttons()
    ...
    def _move_selected_fsect(self, *, direction: str) -> None:
        ...
        self._host._mark_fsects_dirty(True)
        self._host._window.update_selection_sidebar(selection)
        self._host._window.select_fsect_index(target_index)
        self._host._update_fsect_edit_buttons()
        self._host._window.show_status_message(
