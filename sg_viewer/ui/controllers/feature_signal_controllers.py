...
class TsdController:
    ...
    def connect_signals(self) -> None:
        h = self._host
        w = h._window
        h._tsd_preview_refresh_timer.timeout.connect(h._refresh_tsd_preview_lines)
        w.tsd_add_line_button.clicked.connect(h._on_tsd_add_line_requested)
        w.tsd_delete_line_button.clicked.connect(h._on_tsd_delete_line_requested)
        w.tsd_move_line_up_button.clicked.connect(h._on_tsd_move_line_up_requested)
        w.tsd_move_line_down_button.clicked.connect(h._on_tsd_move_line_down_requested)
        w.tsd_save_file_button.clicked.connect(h._on_tsd_save_file_requested)
        w.tsd_generate_file_button.clicked.connect(h._on_tsd_generate_file_requested)
        w.tsd_load_file_button.clicked.connect(h._on_tsd_load_file_requested)
        w.tsd_remove_file_button.clicked.connect(h._on_tsd_remove_file_requested)
        w.tsd_files_combo.currentIndexChanged.connect(h._on_tsd_file_selection_changed)
        w.tsd_add_object_button.clicked.connect(h._on_tsd_add_object_requested)
        w.tsd_duplicate_object_button.clicked.connect(h._on_tsd_duplicate_object_requested)
        w.tsd_remove_selected_object_button.clicked.connect(h._on_tsd_remove_selected_object_requested)
        w.tsd_move_object_up_button.clicked.connect(h._on_tsd_move_object_up_requested)
        w.tsd_move_object_down_button.clicked.connect(h._on_tsd_move_object_down_requested)
        w.tsd_export_objects_button.clicked.connect(h._on_tsd_export_objects_requested)
        w.tsd_skid_marks_button.clicked.connect(h._on_tsd_skid_marks_requested)
        w.tsd_hide_centerline_nodes_checkbox.toggled.connect(h._on_tsd_hide_centerline_nodes_toggled)
        w.tsd_objects_table.itemSelectionChanged.connect(h._on_tsd_object_selection_changed)
        w.tsd_objects_table.cellClicked.connect(h._on_tsd_objects_table_cell_clicked)
        h._tsd_lines_model.dataChanged.connect(h._on_tsd_data_changed)
        h._tsd_lines_model.rowsInserted.connect(h._schedule_tsd_preview_refresh)
        h._tsd_lines_model.rowsRemoved.connect(h._schedule_tsd_preview_refresh)
        h._tsd_lines_model.modelReset.connect(h._schedule_tsd_preview_refresh)
        tsd_selection_model = w.tsd_lines_table.selectionModel()
        if tsd_selection_model is not None:
            tsd_selection_model.selectionChanged.connect(h._on_tsd_selection_changed)
