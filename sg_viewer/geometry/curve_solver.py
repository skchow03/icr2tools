...
from sg_viewer.geometry.solver_primitives import (
    clamp_unit,
    curve_arc_length,
    curve_center_from_fixed_heading,
    curve_tangent_heading,
    heading_angle_error,
...
def _solve_curve_with_fixed_heading(
    ...
    for orientation in {orientation_hint, -orientation_hint}:
        result = curve_center_from_fixed_heading(
            fixed_point,
            moving_point,
            fixed_heading,
            orientation,
